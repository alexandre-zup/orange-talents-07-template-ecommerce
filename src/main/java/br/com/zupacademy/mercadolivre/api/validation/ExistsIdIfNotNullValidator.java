...
public class ExistsIdIfNotNullValidator implements ConstraintValidator<ExistsIdIfNotNull, Long> {
    ...
    @Override
    public void initialize(ExistsIdIfNotNull constraintAnnotation) {
